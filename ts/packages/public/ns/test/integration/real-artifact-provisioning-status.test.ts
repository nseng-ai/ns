...
import { RealArtifactActivationGateway } from "../../src/init/real-artifact-activation.ts";
import { RealArtifactProvisioningStatusGateway } from "../../src/init/real-artifact-provisioning-status.ts";
