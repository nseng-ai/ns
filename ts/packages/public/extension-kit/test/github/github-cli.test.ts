...
import type { CommandRunner, ExecOptions, ExecResult } from "@nseng-ai/ns-foundation/exec";
import {
	GITHUB_CLI_TIMEOUT_MS,
	runGitHubCli,
	runGitHubCliAsExecResult,
} from "@nseng-ai/extension-kit/github/cli";
		...
		expect(calls).toEqual([
			{
				command: "gh",
				args: ["pr", "view", "12"],
				options: { cwd: "/repo", timeout: GITHUB_CLI_TIMEOUT_MS },
			},
		]);
	});
