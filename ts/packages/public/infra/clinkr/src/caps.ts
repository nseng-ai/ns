...
// `@nseng-ai/ns-foundation/cli-theme` and the opt-in stream subpath read from; it must not import `log-update` or any
...
export function resolveSettledNonInteractiveCaps(
	...
	return {
		...
		canRenderUnicode: detectUnicode(env),
	};
}
