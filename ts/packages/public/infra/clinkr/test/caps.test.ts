...
describe("readProcessCapsEnv", () => {
	test("snapshots tty, columns, and env from the process", () => {
		...
		// Neutralize ambient COLORTERM=truecolor and FORCE_COLOR from the test shell so TERM drives
		// the depth. Both outrank TERM in resolveCaps, and an empty value reads as unset.
