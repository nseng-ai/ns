import { noopNsCommandIo, noopNsProgress } from "@nseng-ai/ns/kernel/sdk";
import type { ClinkrDynamicCompletionRequest, NsExtensionApi } from "@nseng-ai/ns/kernel/sdk";
