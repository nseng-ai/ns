...
export const autoslotParity = definePiSurfaceParity([
	{
		...
		notes: "Pi command exposes the SDL code-lifecycle surface while delegating to CCC autoslot orchestration; no dedicated non-Pi skill currently owns the slot-moving variant.",
	},
] as const);
