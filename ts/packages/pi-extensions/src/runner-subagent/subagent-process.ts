...
export interface RunnerSubagentDispatcherContext {
...
export async function dispatchRunnerSubagentProcess<TTerminalInput = unknown>(
	...
	const clock = dependencies.context?.clock ?? systemClock;
	...
	const timers = dependencies.context?.timers ?? systemTimerScheduler;
