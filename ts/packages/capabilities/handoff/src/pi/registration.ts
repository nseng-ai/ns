...
export const handoffParity = definePiSurfaceParity([
	{
		...
		parity: "FULL",
		cli: "ji handoff create",
		skill: "handoff-create",
		ownerObjective: "cross-harness-parity",
		sourcePackage: "@ji/handoff/pi",
		sourceModule: "handoff",
		notes:
			"Pi command expands the portable handoff-create skill; the final artifact is stored through `ji handoff create` after model confirmation.",
	},
	{
		kind: "command",
