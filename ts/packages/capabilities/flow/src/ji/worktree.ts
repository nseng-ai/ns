...
import { createSdlCliExecAdapter, execSdlCommand, execSdlGit } from "@ji/capability-kit/git";
import { formatCommandDetails, formatCommandError, type ExecResult } from "@ji/core/command";
