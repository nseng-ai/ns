import { createSdlClinkrInteraction } from "@ji/capability-kit";
import { confirmInteractiveOrUsageError } from "@ji/clinkr";
import { renderResultBlock, renderResultBlockFromMessage } from "@ji/core/cli-theme";
import {
	defineExtension,
	failed,
	ok,
