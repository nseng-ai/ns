import { dim, glyph, renderBufferedReport } from "@ji/core/cli-theme";
import { commandIoFromSdlExtensionApi, runWithSdlCommandIo } from "@ji/kernel/command-io";
import { renderCapabilitiesForTerminal, type Caps } from "@ji/clinkr";
import { defineExtension, failed, ok, type SdlCommand } from "@ji/kernel/sdk";
