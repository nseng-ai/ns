...
import { runCli } from "@nseng-ai/ns/kernel/cli";
import { createCliCommandIo } from "@nseng-ai/ns/kernel/command-io";
import { noopNsProgress } from "@nseng-ai/ns/kernel/sdk";
import type {
	NsExecOptions,
	ExecResult,
	NsConfirmPrompt,
