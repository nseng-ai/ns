...
const CURRENT_SLOT_ROOT = "/Users/me/.local/state/ns/slots/repos/repo/worktrees/slot-03";
...
function fromManagedCurrentSlot(script: readonly ScriptedExec[]): ScriptedExec[] {
