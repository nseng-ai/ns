...
class FakeMinimalSubmitGateway implements SubmitGateway {
	...
	async updateStackPrs(): Promise<SubmitRunResult> {
		throw new Error("minimal submit must not update upstack PRs");
	}
