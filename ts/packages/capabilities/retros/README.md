...
Aretro is exposed through the ns extension command face:
...
The standalone `aretro` binary is retired. This package intentionally does not expose `@nseng-ai/retros/api`; there is no current in-process Capability API consumer.
