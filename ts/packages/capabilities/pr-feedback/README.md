...
ADR 0039 (formerly numbered 0016) keeps PR Address as the capability-facing seam: reusable GitHub backend mechanics may live in `@nseng-ai/capability-kit/github`, while seam consumers import only the Address Capability API.
