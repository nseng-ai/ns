...
export interface ObjectiveCommandSpec extends ObjectiveSelectionSpec {
	...
	cliSubcommand: "next" | "update" | "close" | "stack-impl";
	description: string;
...
export interface ObjectiveCreateCommandSpec {
	commandName: "ji:objective:create";
...
export const objectiveCommandSpecs: ObjectiveCommandSpec[] = [
	...
	{
		commandName: "ji:objective:update",
	...
	{
		commandName: "ji:objective:stack-impl",
		...
		statusKey: "ji:objective:stack-impl",
