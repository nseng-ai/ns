...
/** Module specifier that extension modules import the SDL SDK from. */
 ...
 * exact SDK object imported by this process, so extension-created commands and
 ...
 *
 * Callers validate the returned value according to the extension point they are
 * loading. Throws when the file cannot be transpiled or imported.
 */
