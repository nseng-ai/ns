...
import { genericCommandStyleSkillNames } from "../src/commands/surfaces.ts";
...
} from "../src/extensions/backing-skill-commands.ts";
import type { PiCommandContext } from "../src/runtime/command-host.ts";
