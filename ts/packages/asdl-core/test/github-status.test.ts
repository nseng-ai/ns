...
describe("GitHub status boundary parsing", () => {
	test("extracts canonical GitHub PR identity", () => {
		expect(
			githubPrIdentityFromUrl("https://github.com/dagster-io/asdl-tools/pull/1741", 1741),
		).toEqual({
			owner: "dagster-io",
			repo: "asdl-tools",
			number: 1741,
		...
		expect(
			githubPrIdentityFromUrl("https://github.com/dagster-io/asdl-tools/pull/1741", 12),
		).toBeUndefined();
		expect(
			githubPrIdentityFromUrl("https://example.com/dagster-io/asdl-tools/pull/1741", 1741),
		).toBeUndefined();
		expect(
			githubPrIdentityFromUrl("https://github.com/dagster-io/asdl-tools/issues/1741", 1741),
		).toBeUndefined();
	});
	...
	test("parses common GitHub remote URL forms", () => {
		expect(
			githubRepositoryIdentityFromRemoteUrl("https://github.com/dagster-io/asdl-tools.git"),
		).toEqual({ owner: "dagster-io", repo: "asdl-tools" });
		expect(
			githubRepositoryIdentityFromRemoteUrl("https://github.com/dagster-io/asdl-tools"),
		).toEqual({ owner: "dagster-io", repo: "asdl-tools" });
		expect(
			githubRepositoryIdentityFromRemoteUrl("git@github.com:dagster-io/asdl-tools.git"),
		).toEqual({ owner: "dagster-io", repo: "asdl-tools" });
		expect(
			githubRepositoryIdentityFromRemoteUrl("ssh://git@github.com/dagster-io/asdl-tools.git"),
		).toEqual({ owner: "dagster-io", repo: "asdl-tools" });
		expect(
			githubRepositoryIdentityFromRemoteUrl("https://example.com/dagster-io/asdl-tools.git"),
		).toBeUndefined();
		expect(
			githubRepositoryIdentityFromRemoteUrl("https://github.com/dagster-io/asdl-tools/extra"),
		).toBeUndefined();
	});

	test("parses GitHub identity from normalized remotes only", () => {
		expect(
			githubRepositoryIdentityFromNormalizedRemoteUrl("ssh://git@github.com/dagster-io/asdl-tools"),
		).toEqual({ owner: "dagster-io", repo: "asdl-tools" });
		expect(
			githubRepositoryIdentityFromNormalizedRemoteUrl("ssh://git@gitlab.com/dagster-io/asdl-tools"),
		).toBeUndefined();
