...
Evidence: \`ts/packages/pi-tools/context-profiler/src/render.ts\`
...
function currentPr1952Thread(options: {
	...
	const path = "ts/packages/pi/src/pr/preview-feedback-view.ts";
	return {
		id: options.id,
		path,
		line: options.line,
...
describe("/pr:preview-feedback", () => {
	...
	test("current PR 1952 roaster details omit machine markers and footer noise", () => {
		...
		expect(details).toContain("Evidence: `ts/packages/pi-tools/context-profiler/src/render.ts`");
