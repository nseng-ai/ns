/**
 * Typed parity accounting for Pi surfaces implemented by @nseng-ai/pi and extracted Pi packages.
 *
 ...
 * `kind:surface`.
 *
 * Scope is intentionally narrow for v1: package modules in @nseng-ai/pi plus
...
export interface BasePiSurfaceParity {
	...
	readonly sourcePackage:
		...
		| "@nseng-ai/flow/pi"
		| "@nseng-ai/handoff/pi"
		| "@nseng-ai/objective/pi"
		| "@nseng-ai/pi/worktree-status";
