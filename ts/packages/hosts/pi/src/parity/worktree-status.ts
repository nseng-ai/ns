...
// The implementation lives in @ji/pi/worktree-status. This record keeps parity
...
export const worktreeStatusParity = definePiSurfaceParity([
	{
		...
		sourcePackage: "@ji/pi/worktree-status",
		sourceModule: "extension",
		notes:
			"This command is Pi-native status UI owned by @ji/pi/worktree-status; the host package records parity for its own footer surface.",
	},
] as const);
