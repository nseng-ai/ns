...
export interface TabKeyInput {
	...
	readonly sequence?: ExplicitUndefined<"key-event", string>;
	readonly ctrl?: ExplicitUndefined<"key-event", boolean>;
	readonly meta?: ExplicitUndefined<"key-event", boolean>;
}
