...
function mountHelloWorldScreen(renderer: CliRenderer, model: JiccHelloWorldModel): void {
	...
	root.add(new TextRenderable(renderer, { id: "nscc-title", content: model.title, fg: "#a6e3a1" }));
	root.add(new TextRenderable(renderer, { id: "nscc-body", content: model.body, fg: "#cdd6f4" }));
	root.add(
		new TextRenderable(renderer, { id: "nscc-footer", content: model.footer, fg: "#f9e2af" }),
	);
