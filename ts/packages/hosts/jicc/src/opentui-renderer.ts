...
function mountHelloWorldScreen(renderer: CliRenderer, model: JiccHelloWorldModel): void {
	...
	root.add(new TextRenderable(renderer, { id: "jicc-title", content: model.title, fg: "#a6e3a1" }));
	root.add(new TextRenderable(renderer, { id: "jicc-body", content: model.body, fg: "#cdd6f4" }));
	root.add(
		new TextRenderable(renderer, { id: "jicc-footer", content: model.footer, fg: "#f9e2af" }),
	);
