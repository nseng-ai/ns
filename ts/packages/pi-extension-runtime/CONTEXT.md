...
*Avoid*: command implementation, workflow owner, CCC orchestration, public npm API.
...
*Avoid*: CLI command, transport protocol, exception boundary.
...
*Avoid*: shell executor, gateway, subprocess policy.
...
*Avoid*: Branch Memory system owner, branch-context attachment owner, CCC observability owner, direct process gateway.
...
*Avoid*: Objective CLI owner, CCC workflow owner, prompt dispatch, hidden branch-derived Objective inference.
