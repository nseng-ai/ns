...
interface ExtensionApiConsumerFixture {
...
function describeExtensionApiFixture(fixture: ExtensionApiConsumerFixture): string {
...
describe("@nseng-ai/pr-feedback/api boundary", () => {
	test("exposes PR feedback and check payload vocabulary from the Extension API", () => {
		...
		const fixture: ExtensionApiConsumerFixture = {
		...
		expect(describeExtensionApiFixture(fixture)).toBe(
