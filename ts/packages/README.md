...
Structure *inside* a container package — which units earn `ji.subpackages` rank, naming, and importer rules — is governed by [`docs/subpackage-conventions.md`](../../docs/subpackage-conventions.md) (ADR 0022/0023).
