import { walkGraphiteAncestors, type GraphiteTopology, type GraphiteWalkTermination } from "@asdl/core/graphite-metadata";
...
export function collectGraphiteTopologyAncestors(options: { readonly branch: string; readonly topology: GraphiteTopology }): GraphiteTopologyBranchWalk {
...
export function collectGraphiteTopologyDescendants(options: { readonly branch: string; readonly topology: GraphiteTopology }): GraphiteTopologyBranchWalk {
