...
import type { NsClinkrCommandRun, CommandSchema } from "./ns-clinkr-command.ts";
...
export type ComposableCommand = CommandDefinition<NsClinkrCommandRun<CommandSchema, unknown>>;
