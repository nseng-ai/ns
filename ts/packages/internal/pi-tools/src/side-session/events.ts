/**
 * The shared event vocabulary for a Pi side-session: the discriminated union both
 * the stack-view compose and the context-profiler interrogation subsystems fold
 * into their (divergent) transcript reducers, plus the single mapper that lowers a
 * raw {@link AgentSessionEvent} onto it.
 *
