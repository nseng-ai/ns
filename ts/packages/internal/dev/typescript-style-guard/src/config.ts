...
export const BAN_PACKAGE_DISPOSITION_TOPOLOGY = "NS_TS_PACKAGE_DISPOSITION_TOPOLOGY";
export const BAN_EXTENSION_PI_SURFACE = "NS_TS_BAN_EXTENSION_PI_SURFACE";
export const BAN_PI_ADAPTER_EXTENSION_IMPORT = "NS_TS_BAN_PI_ADAPTER_EXTENSION_IMPORT";
