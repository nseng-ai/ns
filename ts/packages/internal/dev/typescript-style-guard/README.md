...
not to ship as part of ns-the-product, and owns both the implementation and the
...
runtime workspace dependencies on it must stay inside internal space (enforced by
`NS_TS_INTERNAL_SPACE_ADMISSION`).
