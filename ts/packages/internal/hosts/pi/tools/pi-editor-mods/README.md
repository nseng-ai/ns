...
pi install /absolute/path/to/ns/ts/packages/internal/hosts/pi/tools/pi-editor-mods
pi remove /absolute/path/to/ns/ts/packages/internal/hosts/pi/tools/pi-editor-mods
```
...
```json
{
	"packages": ["../ts/packages/internal/hosts/pi/tools/pi-editor-mods"]
}
```

You can also run `pi install -l ../ts/packages/internal/hosts/pi/tools/pi-editor-mods` and remove it with
`pi remove -l ../ts/packages/internal/hosts/pi/tools/pi-editor-mods`.
