	...
	test.each([
		...
		async (source, promptSource, label) => {
			...
			expect(result.body).toBe(
				[
					`*Automatically generated by \`ns flow ${source}\` from the diff and commit headlines, without author steering, interview, or approval. It may omit intent, rationale, constraints, or context not visible in that evidence.*`,
					"",
					"Generated body",
					"",
					"---",
