...
export const LAND_EXTENSION_ID = "land";
export const LAND_PACKAGE_NAME = "@nseng-ai/flow";

export interface LandExtensionMetadata {
	readonly extensionId: typeof LAND_EXTENSION_ID;
	readonly packageName: typeof LAND_PACKAGE_NAME;
	readonly tier: "extension";
}

export const LAND_EXTENSION_METADATA: LandExtensionMetadata = {
