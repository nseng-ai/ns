...
// generic finite block layout lives in `@nseng-ai/ns-foundation/cli-theme` because the repeated shape was proven across
// Flow and sibling workflow extensions. This module keeps autoslot's domain-local type name and owns the mapping from Flow
