...
Pi commands and skills live in `-ai/pi-ns-handoffs` as presentation/authoring adapters over this extension; Branch Memory details are technical storage evidence, not the default user model.
