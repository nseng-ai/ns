import type { HerdrLaunchCommandBuilder, HerdrLaunchProfile } from "./host-types.ts";
...
export async function launchHerdrHandoffTab(options: {
	...
	const command = options.buildLaunchCommand(options.pickupCommand, options.launchProfile);
