...
export const HERDR_PROMPT_SPACE_IMPL_COMMAND_NAME = nsCommandSurface("herdr", "impl:prompt:space");
export const HERDR_PROMPT_TAB_IMPL_COMMAND_NAME = nsCommandSurface("herdr", "impl:prompt:tab");
export const HERDR_SESSION_SPACE_IMPL_COMMAND_NAME = nsCommandSurface(
	"herdr",
	"impl:session:space",
);
export const HERDR_SESSION_TAB_IMPL_COMMAND_NAME = nsCommandSurface("herdr", "impl:session:tab");
export const HERDR_PLAN_SPACE_IMPL_COMMAND_NAME = nsCommandSurface("herdr", "impl:plan:space");
...
export const HERDR_PLAN_TAB_IMPL_COMMAND_NAME = nsCommandSurface("herdr", "impl:plan:tab");
