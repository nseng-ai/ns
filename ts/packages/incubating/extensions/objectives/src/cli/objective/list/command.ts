...
export async function command() {
	return objectiveNsCommand({
		...
		renderHuman: (data, caps) =>
			renderObjectiveListPretty(data, resolveRenderCapabilities(caps), systemClock.nowMs()),
...
//
// It is a pure function over an injected `Caps` and `nowMs`, so every rung of the extension ladder
