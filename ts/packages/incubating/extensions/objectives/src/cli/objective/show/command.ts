...
import { buildObjectiveBranchAttributionForContext } from "../../../core/branch-attribution.ts";
import type { ObjectiveCliContext } from "../../../core/context.ts";
import { findObjectiveEdgeAnnotation } from "../../../core/edge-lint.ts";
import { pythonStringRepr, removeOneTrailingNewline } from "../../../core/format.ts";
import {
...
import {
	resolveObjectiveRecordTarget,
	targetToEmptyResultFields,
} from "../../../core/objective-target.ts";
...
export async function command() {
	return objectiveNsCommand({
		...
		renderHuman: (data, caps) =>
			renderShowObjectiveHuman(data, resolveRenderCapabilities(caps), systemClock.nowMs()),
