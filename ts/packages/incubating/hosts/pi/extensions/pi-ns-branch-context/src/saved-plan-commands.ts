...
- If the plan includes same-shape edits across multiple files, explicitly choose an execution strategy and apply \`docs/conventions/refactor-execution-strategy.md\`.
