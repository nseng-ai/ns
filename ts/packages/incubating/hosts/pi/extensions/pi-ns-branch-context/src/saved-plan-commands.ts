...
- Derive a meaningful Saved Plan filename slug from the final plan: 3–7 words in lowercase kebab-case.
...
- Safely shell-quote the slug and exact path, then invoke \`enriched-plan exec save --slug '<slug>' --content-file '<exact path>' --format json\`.
