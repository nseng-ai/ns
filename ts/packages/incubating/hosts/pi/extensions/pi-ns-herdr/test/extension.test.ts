...
import type { HandoffExtensionAPI, ToolDefinition } from "@nseng-ai/pi-ns-handoffs/create-flow";
...
describe("herdr Pi extension", () => {
	...
	test("keeps base commands when the exact optional module is absent", async () => {
		...
		const absence = Object.assign(
			new Error("Cannot find package '@nseng-ai/pi-ns-handoffs/create-flow'"),
