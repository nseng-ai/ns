...
export interface BranchCreationProviderFactoryOptions {
	context: BranchContextContext;
	parentBranch: string;
}

export type BranchCreationProviderFactory = (
	options: BranchCreationProviderFactoryOptions,
...
export interface BranchContextExtensionOptions {
	...
	createBranchCreationProvider?: BranchCreationProviderFactory;
}
