...
export default function registerGsExtension(pi: GsExtensionAPI, options: GsExtensionOptions): void {
	registerCommandWithImmediateAck({
		host: pi,
		commandName: GS_AUTOBRANCH_COMMAND.piSurface,
		commandDefinition: {
	...
	registerCommandWithImmediateAck({
		host: pi,
		commandName: GS_RESTACK_RESOLVE_COMMAND.piSurface,
		commandDefinition: {
