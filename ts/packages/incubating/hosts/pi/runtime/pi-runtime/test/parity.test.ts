...
async function collectLivePiExtensionSurfaces(): Promise<LivePiSurface[]> {
	...
	// The worktree-status implementation lives in @nseng-ai/pi-runtime/worktree-status and is
...
describe("Pi extension parity metadata", () => {
	test("all @nseng-ai/pi-runtime command surfaces have parity metadata", async () => {
