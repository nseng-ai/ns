...
export const IMMEDIATE_COMMAND_ACK_MESSAGE_TYPE = "ns-command-ack";
export const IMMEDIATE_COMMAND_PROGRESS_MESSAGE_TYPE = "ns-command-progress";
export const IMMEDIATE_COMMAND_ACK_STATUS_KEY = "ns-command-ack";
