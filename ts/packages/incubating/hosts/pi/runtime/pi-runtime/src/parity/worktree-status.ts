...
// The implementation lives in @nseng-ai/pi-runtime/worktree-status. This record keeps parity
...
export const worktreeStatusParity = definePiSurfaceParity([
	{
		...
		sourcePackage: "@nseng-ai/pi-runtime/worktree-status",
		sourceModule: "extension",
		notes:
			"This command is Pi-native status UI owned by @nseng-ai/pi-runtime/worktree-status; the host package records parity for its own footer surface.",
	},
] as const);
