/**
 * Typed parity accounting for Pi surfaces implemented by @nseng-ai/pi-runtime and extracted Pi packages.
 *
 ...
 * `kind:surface`.
 *
 * Scope is intentionally narrow for v1: package modules in @nseng-ai/pi-runtime plus
...
export interface BasePiSurfaceParity {
	 ...
	 * avoid importing those packages back into @nseng-ai/pi-runtime.
	 */
