...
const TS_ONLY_OPERATIONS = ["get-feedback", "map-branch-prs", "prepare-run", "read-thread-bodies", "record-batch-checkpoint", "stack-feedback-plan", "stack-feedback-preflight", "stack-feedback-prep", "stack-feedback-thread-state", "verify-stack-batch-current"] as const;
