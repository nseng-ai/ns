import type { ZodIssueLike } from "@ns/core/primitives";

/**
 * Kernel-local classifier for routing Zod issues by structural path shape.
 *
 * This intentionally stays private to `@ns/kernel`: it is a small, policy-free
 ...
 * `@ns/core/primitives` unless a second package needs it.
 */
