...
An ns-shipped, ns-owned **Extension** that implements a **Capability** (flow, objective, handoff, slot, branch-context, plans, address, roaster, retros, and **CCC**), as opposed to a third-party extension.
