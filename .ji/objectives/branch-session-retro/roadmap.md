...
- [x] PR 7: create or update the branch retrospective skill so it invokes `aretro exec collect-evidence` and writes semantic recommendations from the returned evidence.
