...
- [~] Continuously reduce semantically redundant optional-undefined declarations.
  ...
  Evidence: repo-wide (`ts`) and scoped before/after counts for both (1) typed optional-undefined properties and (2) undefined-normalization/check code, changed fields, semantic claim, preserved/deferred categories, construction-path notes, and relevant TypeScript validation. Every kept cleanup update should include the repo-wide before/after scorecard, even for a narrow slice. When a slice becomes a PR, put both repo-wide and scoped before/after metrics and their measurement scopes in the PR description.
