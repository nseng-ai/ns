...
- Import/path hints: @nseng-ai/ns-foundation/exec; @nseng-ai/ns-foundation/command
...
- Structural exemptions: the @nseng-ai/ns-foundation/exec adapter itself; genuinely interactive TTY spawns after inspection
