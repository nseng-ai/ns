...
- The documentation `asdl aretro --help` example is stale by default. Current skill guidance explicitly says not to use `asdl aretro`, and plugin smoke tests assert stale `aretro.plugin:build_aretro_plugin` is not mounted.
