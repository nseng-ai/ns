...
- [ ] First readme-driven pass over `references/README-draft.md` (seeded verbatim
      ...
      2026-07-14 Pi-layer survey; `flow-pi-tier-stack-view-promotion` owns the underlying work) — a
...
- [ ] Promote the settled draft over `ts/packages/capabilities/flow/README.md`,
      integrating the workflows tier landed there by `flow-fold-stack-skills-into-workflow-tier`, and slim
