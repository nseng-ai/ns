...
Getting to: revalidate a pinned pre-1.0 provider baseline, supersede the affected Flow-owned direction in ADR 0049, settle each workflow in the GS README, and verify mutations through observed Git, gh-stack, and GitHub facts.
