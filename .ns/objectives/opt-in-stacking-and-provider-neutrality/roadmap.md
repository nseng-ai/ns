...
- [ ] Remove the Herdr startup coupling: no Graphite trunk resolution at extension registration; stack-provider lookup becomes lazy and scoped to the implementation workflows that need it.
...
- [ ] Make Branch Context provider construction policy-selected and lazy: plain-git path constructs no Graphite gateway; creation methods resolve at the composition root.
