...
- `just` (590 files, 6260 tests; objective sweep clean)
...
config, Capability API facade, workflow/deploy inventory, and package publication
surface while removing feature ownership from the `ns` host-surface directory. The
...
- Keep Graphite-aware dispatch source publication out of this prerequisite slice; it
  remains separate follow-on work.
