...
- [ ] Land the shared phase-1 prerequisite PR: establish the production filesystem-path scenario/completion harness with injected fake gateways and add the route-neutral context/completion/temporary-outcome adapter. Do not migrate a command in this PR.
