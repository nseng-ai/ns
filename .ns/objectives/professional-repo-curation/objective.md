...
- **Ontology conflation.** Skill support disposition and family ownership are distinct from package disposition and host ownership; neither inherits from the other. Within the skill system, support disposition, family, globally flat identity, exposure policy, and `metadata.internal` are independent classifications.
