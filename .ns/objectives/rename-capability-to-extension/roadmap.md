...
- [ ] Land the vocabulary layer: root `CONTEXT.md` canonical term + *Avoid* entry, **extension package API** as the replacement for **Capability API**, affected nested CONTEXT files, `CONTEXT-MAP.md` routing if needed, and the docs/prose sweep. API-term evidence: `updates/2026-07-25-extension-package-api-verdict.md`.
