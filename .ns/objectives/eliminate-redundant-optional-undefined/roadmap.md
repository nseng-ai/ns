...
- [x] Continuously classify or remove reintroduced raw optional-undefined candidates.
...
- [x] Maintain reusable candidate-classification and metric knowledge.
...
- [x] Keep review slices coherent, review-substantive, and coarser than tiny trickles.
...
- [x] Gather lessons for making autonomous Objectives work well.
...
- [x] Periodically consider whether a hard guard / allowlist deserves a separate Objective.
