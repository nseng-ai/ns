...
- Targeted caller discovery found no active skill, Pi/CCC wrapper, documentation, TypeScript package, or Python package consumer beyond the package's own tests and workspace/build wiring.
