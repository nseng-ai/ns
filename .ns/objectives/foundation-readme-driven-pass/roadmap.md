...
- [ ] Run the Extension Kit package Subobjective after SDK. The former Capability Kit has already been renamed to `ts/packages/extension-kit`; it currently has no package README or draft.
...
- Foundation refactoring proposals that exceed contract reconciliation; split them into separate records after discussion with the user.
