...
edges:
  ...
  - objective: slots-consumer-dependency-contracts
    annotation: "Owns Flow's focused optional-Slots delivery while the cross-package Objective coordinates dependency contracts and synthesized closure evidence."
---
