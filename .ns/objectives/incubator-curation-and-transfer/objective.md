...
- Graduation is not redesign: the gate is "honest and explainable" (README contract, clean seam, green tests, no incubator imports), never "ideal". Feature work and redesign happen outside graduation slices.
...
- **Perfectionism stall at the gate.** README-driven graduation invites redesign. The gate definition in Non-Goals is the mitigation; if a graduation slice starts growing feature work, split it out.
