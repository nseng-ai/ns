...
- [x] Move repo source-control command/control workflows into CCC.
  ...
  - Keep `/code:submit` as a pure `asdl-dev submit` Pi mirror for now; command-suite placement alone is not enough to justify a CCC wrapper.
