...
- [ ] Repeat the capability subobjective pattern until all active first-party user-facing capabilities are TS-default.
  ...
  - The out-of-sequence `areg` exception is complete, and `slot` also completed out of the previous order after dispatcher retirement. The next default unstarted capability is Roaster / review workflows unless new evidence changes the order.
