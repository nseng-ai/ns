...
- [ ] Repeat the capability subobjective pattern until all active first-party user-facing capabilities are TS-default.
  ...
  - Evidence: `objective` completed as the fourth default TS capability and fed checked-in Markdown record parity, plugin retirement, TypeScript source-shim install, Objective-local legacy machine-output compatibility, and Python deletion/rollback lessons back into [`porting-playbook.md`](porting-playbook.md), the migration ledger, migration debt, and Semantic Update `updates/2026-06-17T045528Z-objective-cutover-playbook-lessons.md`.
