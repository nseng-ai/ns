...
This Objective tracks turning these candidates into actual depth: smaller interfaces, more leverage for callers, and locality for maintainers. Candidates #1 and #2 have shipped; the strongest remaining next slice is #3, because the execution environment is still threaded through handlers rather than bound once into the roaster context.
