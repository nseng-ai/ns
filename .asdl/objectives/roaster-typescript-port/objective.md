...
- **Documentation drift:** the runtime/build/test deletion is complete in this branch, but broader documentation still mentions Python-era surfaces or package paths in places such as `AGENTS.md`, `CONTEXT-MAP.md`, and docs-site installation text. Treat that as the remaining Objective closeout work before archiving or closing the port.
