...
- De-risked 2026-06-10: the divergent exec-runtime capabilities (AbortSignal in plans, streaming callbacks and kill-grace in asdl-dev) were unioned into `@asdl/core/exec`; all TS tests and checks pass after migrating in-repo callers.
