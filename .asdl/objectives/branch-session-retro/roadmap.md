...
- [ ] PR 2: add the reusable `asdl-core` session library with provider-neutral source/query models, the Pi JSONL adapter/parser, and unit coverage for normal, partial, and malformed logs.
