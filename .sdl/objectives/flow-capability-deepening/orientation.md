**Direction: Flow internals get deeper while `sdl-flow/api` stays narrow.**
...
What you see now — mid-migration, do not copy: land-stack behavior and focused tests are in Flow, land-stack chunked/single-plan paths and post-landing slot cleanup now have internal modules, but `src/land.ts`, argv-scripted seams, and some CCC-era naming residue remain.
