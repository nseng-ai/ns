...
- `docs/xdg-base-directory-spec.md`, `docs/pi/README.md`, and `docs/pi/branch-context-workflow.md` intentionally document current live fallbacks. After code deletion, remove or narrow the fallback prose.
