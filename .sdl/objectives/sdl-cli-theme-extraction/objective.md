...
- Slot navigation is resolved: keep shared navigation success rendering Slot-local over `@sdl/cli-theme` primitives rather than promoting Slot navigation grammar into the theme package.
