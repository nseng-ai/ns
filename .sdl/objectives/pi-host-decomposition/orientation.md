...
What you see now — mid-decomposition, do not copy: several Pi-native tools have moved to `ts/packages/pi-tools/`, while runner runtime helpers and terminal helpers intentionally remain neutral `@sdl/pi/...` surfaces; capability mirrors still need thinning.
