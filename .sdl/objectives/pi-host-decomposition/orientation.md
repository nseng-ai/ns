...
What you see now — mid-decomposition, do not copy: large feature subsystems still live under `ts/packages/hosts/pi/src/`; `context-profiler` is the proven Pi-tool package recipe, not a reason to move capability mirrors into Pi-tool packages.
