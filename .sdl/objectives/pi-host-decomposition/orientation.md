...
What you see now — mid-decomposition, do not copy: large feature subsystems still live under `ts/packages/hosts/pi/src/`, and `context-profiler` still has a host parity-registration seam to resolve.
