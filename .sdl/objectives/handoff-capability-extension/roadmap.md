...
- [x] Establish `@sdl/handoff/api` and gateway-injected Handoff Domain Core seams. (Admin-core evidence: updates/2026-06-27T233608Z-handoff-api-admin-core.md; create/pickup/API completion evidence: updates/2026-06-28T013500Z-standalone-cutover-pr3.md)
  ...
  - Evidence: `@sdl/handoff/api` now exports identity, summaries, storage/admin functions, create/read/delete operations, and deleted-branch GC planning/execution with fake-backed tests.

- [x] Migrate Handoff inventory/admin commands to `sdl handoff list`, `sdl handoff delete`, and `sdl handoff gc`. (Admin-leaf evidence: updates/2026-06-27T234932Z-sdl-handoff-admin-leaves.md; cutover evidence: updates/2026-06-28T013500Z-standalone-cutover-pr3.md)
  ...
  - Evidence: grouped SDL `handoff` extension leaves now exist for `list`, `delete`, and `gc`, with SDL scenario tests over fake Branch Memory/Git and shared Handoff-owned schemas/renderers/core. PR3 call-site inventory found no active repo-local blocker requiring `-y`/`-f` aliases, so no short aliases were added.
...
- [x] Implement mechanical `sdl handoff pickup`. (Evidence: updates/2026-06-28T013500Z-standalone-cutover-pr3.md)
...
- [x] Align Pi Handoff adapters and skills over the Handoff API / SDL command core. (Evidence: updates/2026-06-28T013500Z-standalone-cutover-pr3.md)
...
- [x] Run standalone `handoff` cutover inventory and remove the standalone CLI after SDL parity. (Evidence: updates/2026-06-28T013500Z-standalone-cutover-pr3.md)
...
- [x] Refresh Handoff, SDL, Pi, context, and parent Objective documentation. (Evidence: updates/2026-06-28T013500Z-standalone-cutover-pr3.md)
