...
publish: clean check
    uv build --package asdl-tools --package asdl-core --package asdl-dispatcher --package asdl-handoff --package asdl-objectives --package aretro --package roaster --package asdl-slots --package vibechk
    uv publish
