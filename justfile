...
publish: clean check
    uv build --package asdl-tools --package brmem --package asdl-core --package asdl-dispatcher --package asdl-objectives --package asdl-pr-address --package aretro --package asdl-reviewer --package asdl-slots
    uv publish
