...
<!-- PLAN-VERIFICATION-WORKSTREAM:START improve-plan-template -->
...
File naming: `shadcn-improve/plans/NNN-short-slug.md`, numbered in recommended execution order.
...
> in `shadcn-improve/plans/README.md` — unless a reviewer dispatched you and told you they
> maintain the index.
>
...
- **Effort**: S | M | L
- **Risk**: LOW | MED | HIGH
- **Depends on**: shadcn-improve/plans/NNN-*.md (or "none")
...
- [ ] `shadcn-improve/plans/README.md` status row updated
...
## Index file: `shadcn-improve/plans/README.md`
...
<!-- PLAN-VERIFICATION-WORKSTREAM:END improve-plan-template -->
