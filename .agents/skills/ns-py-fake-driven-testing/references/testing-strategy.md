...
**Location**: `tests/gateways/test_fakes.py` (see `ns-fake-driven-test-layout`)
...
**Location**: `tests/gateways/test_real_gateways.py` (see `ns-fake-driven-test-layout`)
...
**Location**: `tests/scenario/` (end-to-end shape) or `tests/unit/` (narrow logic-over-fakes). See `ns-fake-driven-test-layout` for the directory convention.
...
**Location**: `tests/integration/` (see `ns-fake-driven-test-layout`)
