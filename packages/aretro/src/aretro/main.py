...
def build_cli() -> ClinkrGroup:
    ...
    return build_standalone_cli(_build_aretro_spec(), package_name="aretro", entry_point="aretro.main:main")


def main() -> None:
    """Entry point for the standalone ``aretro`` CLI."""
    invoke_standalone_cli(_build_aretro_spec(), package_name="aretro", entry_point="aretro.main:main")
