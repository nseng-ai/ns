...
from asdl_core.gt.types import GtCommandFailure, NoParent, UntrackedBranch
...
class SlotGtDownRequest(ClinkrModel):
...
def run_gt_down(ctx: click.Context, request: SlotGtDownRequest) -> ClinkrExit[GtNavigationTarget]:
    ...
    resolution = resolve_or_checkout_worktree_for_branch(slots_ctx, parent)
