"""Shared plugin contract for standalone and top-level twerk CLIs."""
...
class TwerkPluginSpec(Generic[GroupT]):
...
def invoke_standalone_cli(
    spec: TwerkPluginSpec[click.Group],
    *,
    package_name: str,
) -> None:
