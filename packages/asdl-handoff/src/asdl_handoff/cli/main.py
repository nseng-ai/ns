...
def build_cli() -> ClinkrGroup:
    ...
    return build_standalone_cli(build_handoff_plugin(), package_name="asdl-handoff", entry_point="asdl_handoff.cli.main:main")


def main() -> None:
    """Entry point for the standalone ``handoff`` CLI."""
    invoke_standalone_cli(build_handoff_plugin(), package_name="asdl-handoff", entry_point="asdl_handoff.cli.main:main")
