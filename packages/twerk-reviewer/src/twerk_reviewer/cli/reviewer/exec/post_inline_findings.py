...
from twerk_core.gh.types import PRInlineCommentInput
...
from twerk_reviewer.inline_commentability import FallbackOnlyFinding, classify_inline_findings

_BOT_AUTHOR_LOGIN = "github-actions[bot]"
_MARKER_PREFIX = "twerk-reviewer-inline"
...
def _render_inline_body(marker: str, finding: FindingRow) -> str:
    return "\n".join(
        [
            ...
            finding.details,
            "",
            "_Posted by twerk-reviewer. Re-running may skip this comment by marker._",
        ]
    )
