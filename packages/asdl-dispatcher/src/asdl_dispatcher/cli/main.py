...
def build_cli() -> ClinkrGroup:
    ...
    return build_standalone_cli(build_dispatcher_plugin(), package_name="asdl-dispatcher", entry_point="asdl_dispatcher.cli.main:main")


def main() -> None:
    """Entry point for the standalone ``dispatcher`` CLI."""
    invoke_standalone_cli(build_dispatcher_plugin(), package_name="asdl-dispatcher", entry_point="asdl_dispatcher.cli.main:main")
