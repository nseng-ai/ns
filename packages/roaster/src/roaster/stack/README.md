...
4. Remove command-driven tests: `test_stack_workflow`, `test_stack_triage_runner`, `test_stack_agent_output`, `test_stack_resolver_input`, `test_stack_dry_run`, `test_stack_dashboard`, `test_stack_dashboard_projection`, and `tests/scenario/test_stack_cli`.
...
4. Remove skill-first tests: `test_stack_skill_gate` and `tests/scenario/test_stack_exec_cli`.
