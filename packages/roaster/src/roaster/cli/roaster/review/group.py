...
from roaster.cli.roaster.review.list_matching import run_review_list_matching_command
...
def build_review_group() -> ClinkrGroup:
    return ClinkrGroup(
        ...
        operations=[run_review_list_command, run_review_list_matching_command, run_review_command],
    )
