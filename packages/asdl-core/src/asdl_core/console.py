"""Shared Rich console + table helpers for asdl plugins.
...
the asdl look-and-feel lives in exactly one place.
"""
...
def make_table(*, show_header: bool = True) -> Table:
    """Return a Rich table pre-styled with the canonical asdl look.
