...
def build_cli() -> ClinkrGroup:
    ...
    return build_standalone_cli(build_pr_address_plugin(), package_name="asdl-pr-address")


def main() -> None:
    """Entry point for the standalone ``pr-address`` CLI."""
    invoke_standalone_cli(build_pr_address_plugin(), package_name="asdl-pr-address")
