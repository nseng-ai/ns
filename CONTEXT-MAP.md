...
- [@sdl/plans](./ts/packages/plans/CONTEXT.md) — saved-plan vocabulary for Saved Plans, the Local Plan Store, Source Branch Plan Files, Saved-Plan Selection, Plan Store Directory Evidence, the Plans Capability API, and the package's command-surface and domain-logic boundaries.
- [@sdl/branch-context](./ts/packages/branch-context/CONTEXT.md) — branch-context vocabulary for Branch Context, Attached Plan, Branch Context Creation, Branch Context Attach, the Branch Context Capability API, and the package's command-surface and domain-logic boundaries.
