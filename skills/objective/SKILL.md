...
2. If no slug or path is explicit, run `objective exec list --format md` to enumerate candidate Objective directories under `.asdl/objectives/` and ask the user to choose.
