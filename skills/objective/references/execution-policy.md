...
- External side effects are out of scope by default. Publishing, deploying, mutating GitHub issues/PRs, calling write APIs, or changing external systems requires explicit policy or confirmed preview scope.
