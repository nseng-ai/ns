...
**Location**: `tests/scenario/test_my_feature.py` (end-to-end shape) or `tests/unit/test_my_logic.py` (narrow). See `python-fake-driven-test-layout`.
...
```bash
pytest tests/scenario/test_payment_service.py -v
```
...
**Location**: `tests/integration/test_payment_e2e.py`
...
```bash
pytest tests/scenario/test_bug_negative_balance_not_allowed.py -v
```
...
- [ ] Write fake-check test in `tests/gateways/test_fakes.py` (TestFakeDatabase class)
- [ ] Write real-sanity test in `tests/gateways/test_real_gateways.py` (TestRealDatabase class)
- [ ] Update business logic to call new method
- [ ] Write business logic test over fake in `tests/scenario/test_*.py`
...
#### 5. Test Fake (`tests/gateways/test_fakes.py` — TestFakeDatabase class)
...
#### 6. Test Real (`tests/gateways/test_real_gateways.py` — TestRealDatabase class)
...
```python
# tests/scenario/test_user_service.py
