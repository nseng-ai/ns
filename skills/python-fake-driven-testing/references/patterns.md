...
> **For end-to-end CLI scenario tests** that coordinate multiple fakes and assert on output state, see `fast-scenario-testing.md`. This section covers the lower-level CliRunner mechanics those scenarios build on.
