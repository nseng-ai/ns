...
description: "Address unresolved feedback across every PR in the current Graphite stack with one stack-tip omnibus branch and safe review-thread resolution. Use only for explicit stack-wide PR feedback passes."
metadata:
  internal: true
allowed-tools:
  - "Bash(gt *)"
