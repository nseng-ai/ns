# Set up dprint GitHub Actions CI

**Scope:** Add a GitHub Actions workflow that runs `dprint check` on pushes and
PRs. An existing dprint configuration is required.
...
If neither exists, stop and tell the user to follow [Set up dprint](setup-dprint.md) first. Do
