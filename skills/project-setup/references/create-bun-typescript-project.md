...
**Scope:** Scaffold a well-structured Bun-centric TypeScript project with the
preconditions, conventions, templates, and validation below.
...
Use the template from `../templates/create-bun-typescript-project/package-json.md`. Replace all placeholders. See
the template's CLI variant section if `HAS_CLI` is yes.

### Step 3: Create tsconfig.json

Use the template from `../templates/create-bun-typescript-project/tsconfig.md`. No placeholders to replace.

### Step 4: Create the oxc + bun config files

Use the template from `../templates/create-bun-typescript-project/oxc-config.md` to create `.oxlintrc.json`,
`.oxfmtrc.jsonc`, and `bunfig.toml`. No placeholders to replace.

### Step 5: Create .gitignore

Use the template from `../templates/create-bun-typescript-project/gitignore.md`. No placeholders to replace.
...
Use the templates from `../templates/create-bun-typescript-project/source-files.md` to create:
