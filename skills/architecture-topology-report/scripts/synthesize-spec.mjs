  ...
  return {
    ...
    verdict: {
      ...
      read:
        ...
        + `The circle overlay currently discovers ${plural(analysis.meta.topologyCircleCount ?? analysis.meta.packageCount, "topology circle")}; toggle the graph's circle view for source-component granularity such as <span class="font-mono text-sm">@nseng-ai/core/time</span>.`,
    },
