...
description: "Resolve merge conflicts from an in-progress rebase or merge; also the per-conflict engine that driver skills (e.g. code-gt-restack-resolve) invoke."
allowed-tools:
  - "Bash(git status *)"
  - "Bash(git show *)"
  - "Bash(git diff *)"
