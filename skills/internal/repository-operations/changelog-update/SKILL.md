...
description: "Sync CHANGELOG.md unreleased section with recent commits. Use when the user wants to update the changelog, sync it with commits, or prepare changelog entries. Also handles first-time changelog initialization when no CHANGELOG.md exists."
allowed-tools:
  - "Bash(git *)"
  - "Bash(date *)"
---
