...
```bash
skills/internal/review-system/architecture-topology-report/scripts/topology          # extract, render, open
skills/internal/review-system/architecture-topology-report/scripts/topology --no-open # render only; prints the path
```
