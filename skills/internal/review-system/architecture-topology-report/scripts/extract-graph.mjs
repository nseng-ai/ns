...
// at ns.subpackages. Edges are RUNTIME package manifest edges for the package
...
// Subpath exports are aliases (`@nseng-ai/ns-foundation/result` -> src/primitives/result.ts),
