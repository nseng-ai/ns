...
- For TypeScript symbol/API refactors, prefer deterministic AST/codemod tooling when a suitable repo tool exists; inspect the TypeScript AST before designing broad changes.
