...
- For TypeScript symbol/API refactors, prefer deterministic AST/codemod tooling when a suitable repo tool exists; use ts-morph-based AST inspection before designing broad TypeScript changes.
