...
- No attached entry and saved-plan fallback also fails: report both failures and ask whether to run `branch-context-create`, switch to the implementation branch, or pass an explicit saved plan to `/branch-context:from-plan` first.
