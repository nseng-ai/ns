...
| ------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- |
| `grilling`                                  | `skills/internal/pi-host/pi-grill-ui/SKILL.md`                                                                                                                                                                                                                                | Interview loop re-expressed in Pi structured `grill_ask` vocabulary        | Pending semantic merge at the atomic-round Pi cutover                                     |
| `grilling`                                  | `skills/internal/pi-host/pi-grill-with-docs-ui/SKILL.md`                                                                                                                                                                                                                      | Same, composed with docs-aware behavior                                    | Pending semantic merge at the atomic-round Pi cutover                                     |
| `grilling`                                  | `ts/packages/internal/hosts/pi/tools/pi-tools/src/grill/prompts.ts` (`GRILL_UI_CONTRACT`), `.../grill/result.ts` (end-grill result)                                                                                                                                           | Structured interaction contract layered on the required backend skills     | Pending semantic merge at the atomic-round Pi cutover; pin behavior in its grill UI tests |
...
only their domain additions. The current Pi rows and Saved Plan prompt remain pending
until their atomic-round cutovers; their present singular behavior is still the live
contract in this batch. The post-refresh semantic sweep otherwise remains deferred.
