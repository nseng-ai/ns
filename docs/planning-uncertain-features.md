...
- Marker evidence: marked additions in `.sdl/prompts/plans-write.md`, `skills/enriched-plan-save/SKILL.md`, `ts/packages/pi/src/branch-context/enriched-plan-save.ts`, and associated TypeScript prompt tests.
