...
- [Explorer filesystem-boundary hardening](explorer-filesystem-boundary-hardening.md) — restore guarded in-process explorer support and replace lexical cwd containment with canonical, symlink-aware containment.
