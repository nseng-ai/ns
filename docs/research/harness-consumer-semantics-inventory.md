...
| 3 | `@nseng-ai/pi/models/call` `callPiModelText`        | `ts/packages/hosts/pi/src/kit/models/call.ts:24-39` (discriminated failure reasons)                                                                                    | itself (thin wrapper over pi-ai `completeSimple`)                                                                                                                                                                                                                                                      | internal pi-tools stack-view `enrichment-engine.ts:25-26`/`extension.ts:17`, plus fast draft (`fast-text-draft.ts:10`)                                                                                                                            |
...
| `callPiModelText` five-reason taxonomy, signal/timeout pass-through, lazy pi-ai import                                                                    | PRESERVE (live consumer: pi-tools stack-view)                                                                                | `pi-model-call.test.ts:79-142`                                                                           |
