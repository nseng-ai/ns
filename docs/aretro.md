...
- `@ns/aretro` package-local session adapters parse harness-specific logs into normalized session facts without retaining raw transcript content.
- `@ns/aretro` evidence aggregation turns normalized session facts into deterministic observations.
