...
| `command-io`                    | `ts/packages/infra/core/src/command-io.ts`       | small      | 9                 | SDK-provided service           | `sdk-provided`                                                                        | Interface in `sdl-sdk`; implementation hidden in `@sdl/kernel`; reached via `ctx`                                                       | `@sdl/core/command-io`                                       | Avoid leaking derived gateways onto `ctx`.                                                                                                                                                                                                                                           |
| `progress-phase`                | `ts/packages/infra/core/src/progress-phase.ts`   | small      | 6                 | SDK-provided service           | `sdk-provided`                                                                        | Interface in `sdl-sdk`; kernel implementation; `flow` consumes via `ctx` instead of importing core                                      | `@sdl/core/progress-phase`                                   | Source is pure event/listener types today; the *service* is the SDK-provided concept.                                                                                                                                                                                                |
