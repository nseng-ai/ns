...
The fused create-branch-from-plan flow survives as documented sugar: `branch-context exec create-branch --plan <slug> [--branch-creation git|graphite]`. That sugar keeps the branch-creation policy logic from the previous planned-branch flow: plain git by default, Graphite only when explicitly requested by the caller or wrapper.
...
| `planned-branch exec create`                                                                | `branch-context exec create-branch --plan <slug> [--branch-creation git                         |
...
| Pi `/planned-branch:create`, `/planned-branch:impl`, `/planned-branch:upstack-impl-session` | `/branch-context:create-branch`, `/branch-context:impl`, `/branch-context:upstack-impl-session` |
| skills `planned-branch`, `planned-branch-create`, `planned-branch-impl`                     | `branch-context`, `branch-context-create`, `branch-context-impl`                                |
