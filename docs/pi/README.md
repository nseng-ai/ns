...
| -------------------------------------------------------------- | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `.pi/extensions/objective.ts`                                  | Project-local adapter over engineered behavior   | Loaded by Pi from `.pi/extensions/`; delegates namespaced `/sdl:objective:*` command wrappers to package code.                                                                                                                                                                                                                                                                                            |
...
| `.pi/extensions/handoff.ts`                                    | Project-local adapter over engineered behavior   | Adds `/sdl:handoff:create`, `/sdl:handoff:pickup`, and `/handoff:list` for directed handoff artifacts, including a custom list renderer; also registers `/ccc:handoff-tab` when tool support is available.                                                                                                                                                                                                |
...
| `ts/packages/capabilities/objective/src/pi/extension.ts`       | Engineered implementation                        | Package-tested Objective extension behavior, including the unified `/sdl:objective:next` front door.                                                                                                                                                                                                                                                                                                      |
...
| `ts/packages/capabilities/handoff/src/pi/extension.ts` | Engineered implementation | Package-tested `/sdl:handoff:create`, `/sdl:handoff:pickup`, and `/handoff:list` presentation adapters over the portable `ji handoff ...` command face and Handoff Capability API. |
...
| `ji flow submit` | ji project-local extension command | SDK-only project-local Graphite submit command mirrored into Pi as `/ji:flow:submit`; no `/ji:flow:submit` or legacy submit aliases are retained. |
...
- Repo-owned Pi extension command families should use `/namespace:command` names when introduced or renamed. Use the domain/CLI namespace when obvious, such as `/objective:list`, `/sdl:objective:next`, or `/sdl:objective:stack-impl`. Reserve `/skill:<name>` for Pi's skill-command namespace and do not register extension commands under `skill:*`.
...
2. Resolve the duplicate Objective stack implementation surface by using the namespaced Pi wrapper `/sdl:objective:stack-impl` and the portable skill `/skill:objective-stack-impl`. Completed.
...
7. Categorize the remaining repo-owned workflow families. Completed; branch-context planning now uses the `/ji:plan:*` and `/ji:branch-context:*` Pi command families plus public installed agent skills, handoff artifacts use final `/handoff:*` command names and `handoff-*` skills, and branch retrospective remains intentionally skill/CLI-centered around `/skill:branch-retro` plus `ji aretro exec collect-evidence`.
...
| `/sdl:objective:stack-impl` plus `/skill:objective-stack-impl`                                                                                                                                                                                              | Resolved Objective stack implementation surface: Pi uses the namespaced picker wrapper; Codex/Claude use the portable skill; no public prompt-template duplicate remains.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| `/sdl:objective:next` plus `/skill:objective-next`                                                                                                                                                                                                          | Unified Objective advancement front door: recommends next work, steers planning, offers an execution preview when explicit Runner Policy / Definition of Progress prose allows it, or executes a concrete current-session recommendation when the user gives a clear affirmative confirmation. The removed proto runner surface is not retained as a separate Pi command or skill.                                                                                                                                                                                                                                                                                                                                     |
