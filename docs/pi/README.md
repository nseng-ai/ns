...
| `.pi/extensions/handoff.ts`                                       | Project-local adapter over engineered behavior | Adds `/handoff:save`, `/handoff:load`, and `/handoff:list` for directed handoff artifacts.                              |
...
| Handoff artifact workflow (`/handoff:save`, `/handoff:load`, `/handoff:list`)             | Final project-local handoff surface. Users save, load, list, and resume from directed handoff artifacts without thinking in Branch Memory terms; storage details are technical locators only. No old `brmem`-named handoff aliases are retained.                                                                                                                                                                          |
