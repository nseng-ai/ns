...
| `ts/packages/capabilities/objectives/src/pi/extension.ts`      | Engineered implementation                           | Package-tested Objective extension behavior, including the unified `/ns:objective:next` front door.                                                                                                                                                                                                                                                                                |
