...
| `@nseng-ai/pi-ns-herdr`                                                                      | Engineered package extension                        | Directly discovers the exact Herdr catalog, including resource operations, three `/ns:herdr:impl:*` workflows, and conditional `/ns:herdr:tab:handoff`, over `@nseng-ai/herdr/api`.                                                                                                                                                                                                                                                                                        |
