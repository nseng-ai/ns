...
| `.pi/extensions/agents.ts`                                     | Project-local adapter over engineered behavior      | Registers the `explore` and `dispatch_runner_subagent` tools plus the `/ns:agents:fleet` navigator through `@nseng-ai/ns-pi-subagents/extension`.                                                                                                                                                                                                                             |
