...
| `.pi/extensions/planned-branch.ts`                                        | Project-local adapter over engineered behavior | Adds `/plans:write`, `/plans:grill-and-write`, `/planned-branch:create`, `/planned-branch:up-and-impl`, and `/planned-branch:impl`, defaulting this repo to Graphite creation.                                     |
