...
| `.pi/extensions/ccc.ts`                                        | Project-local adapter over engineered behavior      | Registers `/ns:ccc:sidebar:pr-summary`, `/ns:ccc:sidebar:objective-summary`, `/ns:ccc:workspace:dispatch-plan`, `/ns:ccc:surface:dispatch-plan`, `/ns:ccc:workspace:open-branch`, and `/ns:ccc:workspace:dispatch-prompt` through the private CCC command suite.                                                                                                                   |
