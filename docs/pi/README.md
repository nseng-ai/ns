...
| `.pi/extensions/handoff.ts`                                       | Project-local adapter over engineered behavior | Adds `/handoff:create`, `/handoff:pickup`, and `/handoff:list` for directed handoff artifacts.                          |
...
| `ts/packages/pi-extensions/src/handoff.ts`                        | Engineered implementation                      | Package-tested handoff save/pickup/list command behavior over the Branch Memory handoff storage contract.               |
