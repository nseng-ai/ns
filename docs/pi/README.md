...
| `.pi/extensions/cmux.ts`                                       | Project-local adapter over engineered behavior      | Registers `/ns:cmux:sidebar:session-summary`, `/ns:cmux:sidebar:branch-state-summary`, `/ns:cmux:sidebar:objective-summary`, `/ns:cmux:workspace:dispatch-plan`, `/ns:cmux:surface:dispatch-plan`, `/ns:cmux:workspace:open-branch`, and `/ns:cmux:workspace:dispatch-prompt` through the private CCC command suite.                                                                                                                                                                                                                                                                                                                            |
...
| CCC workspace/sidebar/session command suite (`/ns:cmux:handoff-tab`, `/ns:cmux:sidebar:session-summary`, `/ns:cmux:sidebar:branch-state-summary`, `/ns:cmux:sidebar:objective-summary`, `/ns:cmux:workspace:dispatch-plan`, `/ns:cmux:surface:dispatch-plan`, `/ns:cmux:workspace:open-branch`, `/ns:cmux:workspace:dispatch-prompt`) | Promoted to `.pi/extensions/ccc.ts` plus engineered CCC-backed adapters. Manual sidebar commands remain available; workspace-opening commands do not auto-queue sidebar updates pending CCC/cmux targeting rearchitecture. `/ns:cmux:surface:dispatch-plan` launches the dispatch-plan child Pi in a new cmux surface in the caller workspace instead of opening a new workspace. `/ns:cmux:handoff-tab` creates a handoff via the portable handoff workflow, then opens a focused cmux tab; old cmux-prefixed compatibility aliases and old `/handoff-tab` are not current project commands.                                                                                                                                      |
