...
| `.pi/extensions/handoff.ts`                                       | Project-local adapter over engineered behavior | Adds `/handoff:create`, `/handoff:load`, and `/handoff:list` for directed handoff artifacts.                            |
...
| `ts/packages/pi-extensions/src/handoff.ts`                        | Engineered implementation                      | Package-tested handoff save/load/list command behavior over the Branch Memory handoff storage contract.                 |
...
| Handoff artifact workflow (`/handoff:create`, `/handoff:load`, `/handoff:list`)           | Final project-local handoff surface. Users create, load, list, and resume from directed handoff artifacts without thinking in Branch Memory terms; storage details are technical locators only. No old `brmem`-named handoff aliases are retained.                                                                                                                                                                        |
