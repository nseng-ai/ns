...
| `ts/packages/internal/pi-tools/src/pr-previews/extension.ts`   | Internal Pi-tool package                            | Registers the read-only `/pr:preview-feedback` modal preview; download/editor-prefill and feedback watch behavior remain in `@nseng-ai/pi`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
