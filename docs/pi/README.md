...
| `.pi/extensions/sdl.ts`                                           | Project-local adapter over engineered behavior | Adds primary native `/sdl:changes`, `/sdl:cp`, and `/sdl:submit` commands over the `sdl` CLI, plus nested `/sdl:code:*` code-lifecycle surfaces for changes, autobranch, autoslot, land, push, and trunk pull.                                                                                                  |
...
| `ts/packages/pi-extensions/src/sdl-extension.ts`                  | Engineered implementation                      | Mirrors native SDL commands into Pi as primary `/sdl:changes`, `/sdl:cp`, and `/sdl:submit` commands, plus the currently restored nested `/sdl:code:*` code-lifecycle commands.                                                                                                                                 |
...
6. Consolidate the local codebase/source-control commands into SDL code-lifecycle surfaces without legacy aliases. Completed for the currently restored command set; fresh RPC inventory should report `/code:pr-feedback-watch` as the remaining non-SDL review watch surface, primary `/sdl:changes`, `/sdl:cp`, and `/sdl:submit` SDL mirrors, nested `/sdl:code:changes`, `/sdl:code:autobranch`, `/sdl:code:autoslot`, `/sdl:code:land`, `/sdl:code:push`, and `/sdl:code:pull-trunk`, with no legacy `/code:changes`, `/code:cp`, `/code:checkpoint`, `/code:autobranch`, `/code:autoslot`, `/code:land`, `/code:push`, `/code:pr-regen`, `/dev:cp`, `/dev:submit`, `/dev:preview-url`, `/cp`, `/newbr`, `/submit`, `/gh:land`, `/land-stack`, or `/gt:land-stack` aliases. PR-regeneration mirrors remain parked until their SDL command entries migrate back.
...
| `/sdl:code:changes`                                                                                                                                                                                                                                         | Nested code-lifecycle SDL alias over `sdl changes`. Checkpoint does not have a nested code-lifecycle alias in the current project-local extension slice; use primary `/sdl:cp`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| `/sdl:code:regenerate-pr`                                                                                                                                                                                                                                   | Parked until the PR metadata regeneration SDL command migrates back. Legacy `/code:pr-regen` is not registered; review-feedback watch remains outside the SDL code-lifecycle family, and no flat `/sdl:regenerate-pr` Pi mirror is registered in this slice.                                                                                                                                                                                                                                                                                                                                                                                                                                           |
