...
| `ts/packages/hosts/pi/src/handoff/extension.ts`                             | Engineered implementation                      | Package-tested handoff create/pickup/list command behavior and card-style list rendering over the Branch Memory handoff storage contract.                                                                                                                                                                       |
