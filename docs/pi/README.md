...
| `.pi/extensions/cmux.ts`                                                  | Project-local adapter over engineered behavior | Registers `/cmux:pr-sidebar`, `/cmux:objective-sidebar`, `/cmux-slot:dispatch-plan`, `/cmux-slot:open-branch`, and `/cmux-slot:dispatch-prompt` through the package cmux suite.                                    |
