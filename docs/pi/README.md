...
| `/code:submit`                                                                            | Mirrored `asdl-dev submit` command: submits or updates the current Graphite stack with guarded headless submit behavior. Legacy `/dev:submit` and `/submit` aliases are not registered.                                                                                                                                                                                                                                   |
