...
- **gh-stack:** locally installed official `github/gh-stack` extension v0.1.0, observed through `gh stack version`, machine-readable `gh stack view --json`, command help, and non-mutating probes. It is pre-1.0 and may drift.
